...
CREATE TABLE T_OBJETIVO(
	ID_OBJETIVO INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador del objetivo físico de un usuario',
    ...
    FK_USUARIO INT NOT NULL COMMENT 'Identificador FK de la tabla usario registrado.',
