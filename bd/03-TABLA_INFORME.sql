...
CREATE TABLE T_INFORME(
	ID_INFORME INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Identificador de la tabla de informe del perfil deportista del usuario.',
	FK_OBJETIVO INT NOT NULL COMMENT 'Identificador FK para la tabla objetivo',
	N_EDAD INT NOT NULL COMMENT 'Edad del usuario que se somete al cambio físico',
	D_SEXO ENUM('Masculino', 'Femenino') NOT NULL COMMENT 'Define el sexo del usuario (`Masculino`, `Femenino`)',
	N_ALTURA INT NOT NULL COMMENT 'Altura del usuario, en centímetros',
