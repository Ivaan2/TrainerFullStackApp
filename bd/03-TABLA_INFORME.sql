...
CREATE TABLE T_INFORME(
    ...
    N_BICEPS DECIMAL(5,2) COMMENT 'Longitud del bíceps en cm',
    ...
    D_SEGUIMIENTO_DIETA ENUM('NADA', 'MODERADA', 'ALTERADA', 'ESTRICTA') COMMENT 'Establece el cumplimiento de la dieta en cada informe',
	D_NIVEL_ACTIVIDAD ENUM('SEDENTARIO', 'DESCARGA', 'MODERADA', 'ALTA', 'INTENSA') NOT NULL COMMENT 'Indica el nivel de actividad física del usuario.',
    N_DIAS_ENTRENO TINYINT UNSIGNED COMMENT 'Establece los dias de entreno de esta semana',
    ...
    CHECK (N_DIAS_ENTRENO BETWEEN 0 AND 7)
